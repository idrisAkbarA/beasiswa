...
class initBeasiswa extends Command
{
    ...
    public function handle()
    {
        ...
        for ($i = 0; $i < 20; $i++) {
            ...
            $beasiswa->awal_survey = $awal_survey;
            $beasiswa->akhir_survey = $akhir_survey;
            $beasiswa->fields = "[{\"date\": false, \"type\": \"Jawaban Pendek\", \"index\": 1, \"value\": null, \"isLulus\": null, \"pilihan\": {\"items\": [{\"label\": null}], \"required\": true}, \"required\": true, \"checkboxes\": {\"items\": [{\"label\": null}]}, \"pertanyaan\": \"adasd a asd\", \"multiUpload\": {\"items\": [{\"label\": null, \"value\": null, \"isSelected\": false}]}}, {\"date\": false, \"type\": \"Jawaban Angka\", \"index\": 2, \"value\": null, \"isLulus\": null, \"pilihan\": {\"items\": [{\"label\": null}], \"required\": false}, \"required\": true, \"checkboxes\": {\"items\": [{\"label\": null}]}, \"pertanyaan\": \"asdasdasdas\", \"multiUpload\": {\"items\": [{\"label\": null, \"value\": null, \"isSelected\": false}]}}, {\"date\": false, \"type\": \"Paragraf\", \"index\": 3, \"value\": null, \"isLulus\": null, \"pilihan\": {\"items\": [{\"label\": null}], \"required\": false}, \"required\": true, \"checkboxes\": {\"items\": [{\"label\": null}]}, \"pertanyaan\": \"asdasd asd as\", \"multiUpload\": {\"items\": [{\"label\": null, \"value\": null, \"isSelected\": false}]}}, {\"date\": false, \"type\": \"Upload File\", \"index\": 4, \"value\": null, \"isLulus\": null, \"pilihan\": {\"items\": [{\"label\": null}], \"required\": false}, \"required\": true, \"checkboxes\": {\"items\": [{\"label\": null}]}, \"pertanyaan\": \"asdas asdas\", \"multiUpload\": {\"items\": [{\"label\": null, \"value\": null, \"isSelected\": false}]}}, {\"date\": false, \"type\": \"Multiple Upload\", \"index\": 5, \"value\": null, \"isLulus\": null, \"pilihan\": {\"items\": [{\"label\": null}], \"required\": false}, \"required\": true, \"checkboxes\": {\"items\": [{\"label\": null}]}, \"pertanyaan\": \"asdasd ada sad asd asd\", \"multiUpload\": {\"items\": [{\"label\": \"sdf sdf sdf\", \"value\": null, \"isSelected\": false}, {\"label\": \"adas gas gjhfgh\", \"value\": null, \"isSelected\": false}, {\"label\": \"q gsfdg hdf\", \"value\": null, \"isSelected\": false}]}}, {\"date\": false, \"type\": \"Pilihan\", \"index\": 6, \"value\": null, \"isLulus\": null, \"pilihan\": {\"items\": [{\"label\": \"adas\"}, {\"label\": \"asdasd ad\"}], \"required\": false}, \"required\": true, \"checkboxes\": {\"items\": [{\"label\": null}]}, \"pertanyaan\": \"fsfdg sfg s\", \"multiUpload\": {\"items\": [{\"label\": null, \"value\": null, \"isSelected\": false}]}}, {\"date\": false, \"type\": \"Checkboxes\", \"index\": 7, \"value\": [], \"isLulus\": null, \"pilihan\": {\"items\": [{\"label\": null}], \"required\": false}, \"required\": true, \"checkboxes\": {\"items\": [{\"label\": \"adas asd as asd a\"}, {\"label\": \"asdas asd as asd\"}]}, \"pertanyaan\": \"fsdf sdf sdf sdf sd fsdf\", \"multiUpload\": {\"items\": [{\"label\": null, \"value\": null, \"isSelected\": false}]}}, {\"date\": false, \"type\": \"Tanggal\", \"index\": 8, \"value\": null, \"isLulus\": null, \"pilihan\": {\"items\": [{\"label\": null}], \"required\": false}, \"required\": true, \"checkboxes\": {\"items\": [{\"label\": null}]}, \"pertanyaan\": \"zdzdfda aef\", \"multiUpload\": {\"items\": [{\"label\": null, \"value\": null, \"isSelected\": false}]}}]";
